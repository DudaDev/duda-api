...
function createContentHandler(fetcher) {
    ...
    return {
        ...
        getLocationData(siteName, locationID) {
            return fetcher.get(`${SITE_ENDPOINT}${siteName}/${MULTI_LOCATION_ENDPOINT}${locationID}`)
        },
        ...
        updateLocation(siteName, locationID) {
            return fetcher.psot(`${SITE_ENDPOINT}${siteName}/${MULTI_LOCATION_ENDPOINT}${locationID}`)
        },
        
        deleteLocation(siteName, locationID) {
            return fetcher.delete(`${SITE_ENDPOINT}${siteName}/${MULTI_LOCATION_ENDPOINT}${locationID}`)
        },
        ...
        uploadResource(siteName, data) {
            return fetcher.post(
                `${SITE_ENDPOINT}resources/${siteName}/upload`,
                data
            );
        },
